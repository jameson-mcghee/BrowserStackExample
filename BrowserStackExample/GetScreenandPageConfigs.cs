    ...
    public class GetScreenandPageConfigs : GlobalMethods
    {
        ...
        public static async Task<dynamic> GetPageConfigRequest(int siteId)
        {
            string pageConfigUrl = 
                "https://api-stage.tegna-tv.com/mobile/configuration-ro/getStationAppConfig/" + siteId + "/mobile?subscription-key=fdd842925eb6445f85adb84b30d22838";
        ...
        public static async Task<dynamic> GetScreenConfigRequestByPageName(string pageName)
        {
            string screenConfigByNameUrl = 
                "https://api-stage.tegna-tv.com/mobile/configuration-rw/getScreenConfigByName?subscription-key=fdd842925eb6445f85adb84b30d22838";
